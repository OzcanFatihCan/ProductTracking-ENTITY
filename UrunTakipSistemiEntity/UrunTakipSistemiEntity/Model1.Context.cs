...
namespace UrunTakipSistemiEntity
{
    ...
    public partial class DbEntityUrunTakipEntities : DbContext
    {
        public DbEntityUrunTakipEntities()
            : base("name=DbEntityUrunTakipEntities")
        {
        }
        ...
        public virtual ObjectResult<string> STOKMARKAMAX()
        {
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<string>("STOKMARKAMAX");
        }
    }
}
